...
namespace Qt\Component\Quiztools\Administrator\View\Orders;
...
use Qt\Component\Quiztools\Administrator\Model\OrdersModel;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_QUIZTOOLS_ORDERS_TITLE'), 'fas fa-basket-shopping quiztools-orders');
        ...
        if (!$this->isEmptyState && $canDo->get('core.delete')) {
            $toolbar->delete('orders.delete', 'JTOOLBAR_DELETE')
                ->message('COM_QUIZTOOLS_ORDERS_CONFIRM_DELETE')
                ->listCheck(true);
        }
