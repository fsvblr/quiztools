...
namespace Qt\Component\Quiztools\Administrator\View\Subscriptions;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_QUIZTOOLS_SUBSCRIPTIONS_TITLE'), 'fas fa-table-cells-column-lock quiztools-subscriptions');
        ...
        if (!$this->isEmptyState && $canDo->get('core.delete')) {
            $toolbar->delete('subscriptions.delete', 'JTOOLBAR_DELETE')
                ->message('COM_QUIZTOOLS_SUBSCRIPTIONS_CONFIRM_DELETE')
                ->listCheck(true);
        }
