...
namespace Qt\Component\Quiztools\Administrator\View\Order;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(
            $is_new ? Text::_('COM_QUIZTOOLS_ORDER_TITLE_NEW') : Text::_('COM_QUIZTOOLS_ORDER_TITLE_EDIT'),
            'fas fa-basket-shopping quiztools-order'
        );
        ...
        if (!$checked_out && ($canDo->get('core.edit') || $canDo->get('core.create'))) {
            ...
            if (!empty($this->item->id)) {
                $toolbar->basicButton('order-reactivate', 'COM_QUIZTOOLS_ORDER_TOOLBAR_BTN_REACTIVATE')
