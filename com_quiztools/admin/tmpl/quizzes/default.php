...
if ($saveOrder && !empty($this->items)) {
	$saveOrderingUrl = 'index.php?option=com_quiztools&task=quizzes.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTMLHelper::_('draggablelist.draggable');
}

$display_total_score_note = false;

?>
<form action="<?php echo Route::_('index.php?option=com_quiztools&view=quizzes'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
				...
				<?php else : ?>
                    <table class="table" id="quizzesList">
                        <caption class="visually-hidden">
							<?php echo Text::_('COM_QUIZTOOLS_QUIZZES_TABLE_CAPTION'); ?>,
                        ...
                        <tr>
                            ...
                            <th scope="col">
								<?php echo HTMLHelper::_('searchtools.sort', 'COM_QUIZTOOLS_QUIZZES_HEADING_TITLE', 'a.title', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" class="w-15 d-none d-md-table-cell">
								<?php echo HTMLHelper::_('searchtools.sort', 'COM_QUIZTOOLS_QUIZZES_HEADING_CATEGORY', 'category_title', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" class="w-15 text-center d-none d-md-table-cell">
								<?php echo HTMLHelper::_('searchtools.sort', 'COM_QUIZTOOLS_QUIZZES_HEADING_TOTAL_SCORE', 'a.total_score', $listDirn, $listOrder); ?>
                            </th>
                            <th scope="col" class="w-15 text-center d-none d-md-table-cell">
						...
						<?php foreach ($this->items as $i => $item) :
							...
							$item->cat_link = Route::_('index.php?option=com_categories&extension=com_quiztools&task=edit&type=other&cid[]=' . $item->catid);
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="<?php echo $item->catid; ?>">
                                ...
                                <td class="text-center">
									<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'quizzes.', $canChange, 'cb'); ?>
                                </td>
                                <th scope="row">
                                    <div class="break-word">
										<?php if ($item->checked_out) : ?>
											<?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'quizzes.', $canCheckin); ?>
										<?php endif; ?>
										<?php if ($canEdit) : ?>
                                            <a href="<?php echo Route::_('index.php?option=com_quiztools&task=quiz.edit&id=' . (int) $item->id); ?>"
                                ...
                                <td class="text-center d-none d-md-table-cell">
                                    ...
                                    <?php else: ?>
                                        ...
                                        echo Text::_('COM_QUIZTOOLS_QUIZZES_TEXT_POOL');
                                        ?>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center d-none d-md-table-cell">
                    ...
                    <?php if ($display_total_score_note): ?>
                        <?php echo Text::_('COM_QUIZTOOLS_QUIZZES_TOTAL_SCORE_NOTE'); ?>
                    <?php endif; ?>
