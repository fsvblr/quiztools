    ...
    public function QuestionOptionsGetFinalPageHtml($event): bool
    {
        ...
        $html .= '<div class="result-options ' . $this->name . '">
                <div class="result-options-header">
                    ...
                    <div class="w-65">' . Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_HEADING_OPTION_TEXT') . '</div>
                    <div class="w-15 text-center">' . Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_HEADING_OPTION_RIGHT_ANSWER') . '</div>
                    <div class="w-15 text-center">' . Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_HEADING_OPTION_USER_ANSWER') . '</div>
                </div>';
            ...
            $html .= '<div class="result-options-row row' . $i % 2 . '">
                    ...
                    <div class="w-15 text-center">';
                        if ($option->is_correct) {
                            ...
                            alt="' . Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_OPTION_ALT_RIGHT_ANSWER') . '" />';
                        }
                    $html .= '</div>
                    <div class="w-15 text-center">';
                        if ($option->user_answer) {
                            ...
                            alt="' . Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_OPTION_ALT_USER_ANSWER') . '" />';
                        }
                    $html .= '</div>
                </div>';
        ...
        $html .= Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_USER_SCORE') . ': ';
        ...
        if ($data->withFeedback) {
            ...
            if (!empty($feedback['text'])) {
                $html .= '<div class="result-options-feedback"><span>' .
                    Text::_('PLG_QUIZTOOLS_MCHOICE_FINAL_RESULT_FEEDBACK') . ': </span>' . QuiztoolsHelper::cleanHtml($feedback['text']) . '</div>';
            }
        }
