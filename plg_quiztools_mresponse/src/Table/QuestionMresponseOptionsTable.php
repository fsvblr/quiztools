...
class QuestionMresponseOptionsTable extends Table
{
    ...
    {
        parent::__construct('#__quiztools_questions_mresponse_options', 'id', $db, $dispatcher);
    }
	...
	public function check()
	{
		...
		if (trim($this->option) === '') {
			throw new \Exception(Text::_('PLG_QUIZTOOLS_MRESPONSE_WARNING_PROVIDE_OPTION_TEXT'));
		}
